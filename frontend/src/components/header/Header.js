...
const Header = () => {
  ...
  const checkInDate = location.state?.checkInDate ? new Date(location.state.checkInDate) : null;
  const checkOutDate = location.state?.checkOutDate ? new Date(location.state.checkOutDate) : null;
  ...
  return (
    <>
      <div className={`header ${isScrolled || !isHomePage ? 'header-white' : 'header-black'}`}>
        <Link to='/'>
          <img
              ...
              <>
                <div className="search-bar-container">
                  <div className="search-bar">
                    ...
                    <div className="search-bar-text">{checkInDate ? formatDate(checkInDate) : 'Any Week'}</div>
                    <div className="search-bar-text">{checkOutDate ? formatDate(checkOutDate) : 'Add guests'}</div>
                      ...
                      <div className="profile-div">
                        <div className="dropdown">
                          ...
                          <div className="dropdown-content">
                            ...
                            <span onClick={handleSignOut} className="link">Sign Out</span>
                          </div>
