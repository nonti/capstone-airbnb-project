...
const CreateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/accommodations', data, {
        headers: {
    ...
    <form onSubmit={handleSubmit}>
      <div className="form-group">
          ...
          <div className="basic">
            ...
            <div className="basic_count">
              <RemoveCircleOutline
                ...
                sx={{ fontSize: "25px", cursor: "pointer", "&:hover": { color: '#ff354f' } }}
              />
              <p>{guests}</p>
              <AddCircleOutline
        ...
        <div className="amenit">
          ...
          />
          <button type="button" className='add' onClick={handleAddAmenity}>Add</button>
        </div>
                    ...
                    <Draggable key={photo.name} draggableId={photo.name} index={index}>
                      {(provided) => (
                        ...
                        >
                          ...
                          <DeleteOutlineOutlinedIcon onClick={() => handleRemovePhoto(index)} />
                        </div>
                      )}
                    </Draggable>
                  ))}
        ...
        <div className='create-cancel'>
          ...
          <button className='cancel' type="button" onClick={() => {
            setFormData({ title: '', location: '', listingName: '', price: '', type: '', description: '' });
            setGuests(1);
            setBedrooms(1);
            setBeds(1);
            setBathrooms(1);
